...
export default function Lftimg_RgtTxt(props){
    return(
      ...
      <div className="text-content flex-1 pr-0 min-w-[300px] text-center lg:text-left md:flex md:flex-col md:h-full md:justify-center md:items-center md:pr-4">
        ...
        <div className=" flex w-full md:justify-start md:ml-[15%] "><Link to={props.content.add}>
          <button className="startbtn bg-green-500 text-white border-none py-1 px-3 rounded-full font-normal cursor-pointer text-xs transition-transform duration-300 ease-in-out hover:bg-green-700 hover:scale-125 md:py-2 md:px-4 md:font-bold md:text-sm ">{props.content.button}</button></Link>
        </div>
      </div>
