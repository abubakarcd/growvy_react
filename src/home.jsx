...
function Home(){
    ...
    const tolfttxt_rgtimg={h1:" E-Commerce Owner?",p:"Optimize your business with smart asset management, growth strategies and cutting-edge solutions to boosts slaes and efficiency with Growvy.",button:"Plans",img:ecommerce_owner,add:"/pricing"}
    const tolftimg_rgttxt={button:"Schedule Call Now",p:"Join over 10k Users Worldwide. Start Scheduling in less than 1 minute.",img:call,add:"/jobs"}
