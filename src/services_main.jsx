  ...
  const sections = [
    {
      img: img1,
      h3: "Hiring",
      p: "Access a vast talent pool to hire the right candidates quickly and affordably.",
    },
    {
      img: img2,
      h3: "E-commerce",
      p: "Drive expansion with targeted strategies and market-driven solutions.",
    },
    {
      img: homesec4,
      h3: "Business",
      p: "Optimize and manage business resources with data-backed insights",
    },
  ];
  return (
    <>
          ...
          {sections.map((content, index) => (
            <div className=" rounded-lg overflow-hidden relative" key={index}>
              ...
              <div className="border-2 border-black p-6 pt-8 rounded-lg">
                ...
                <p className="text-gray-600 text-sm mb-4">{content.p}</p>
              </div>
