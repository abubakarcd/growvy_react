    ...
    <footer className="bg-gray-50 text-black px-5 py-8 flex flex-col items-center gap-8 w-full relative bottom-0 left-0 shadow-[0_-2px_5px_rgba(0,0,0,0.05)] z-10 md:flex-row md:justify-around md:items-start md:py-10 md:px-8 md:gap-0">
      ...
      <div className="flex flex-col items-start">
        <ul className="list-disc pl-5 space-y-2 mb-5 md:mb-8">
          ...
          <li>
            <Link to="/services" className="text-gray-800 hover:underline">
              Services
            </Link>
          </li>
          <li>
            <Link to="/pricing" className="text-gray-800 hover:underline">
              Plans & Pricing
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/success" className="text-gray-800 hover:underline">
              Success Stories
            </Link>
          </li>
          <li>
            <Link to="/jobs" className="text-gray-800 hover:underline">
              Jobs
            </Link>
          </li>
        </ul>
